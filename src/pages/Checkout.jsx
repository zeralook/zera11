      ...
      <section className="section" style={{ paddingTop: 60 }}>
        <div className="container">
          <div className="empty-state">
            <div className="ic"><Icon3D name="bag" size={72} /></div>
  ...
  if (submitted) return (
    <PageHead title="تم إرسال الطلب" crumb="الرئيسية / إتمام الطلب">
      <section className="section" style={{ paddingTop: 60 }}>
        <div className="container">
          <div className="empty-state">
            <div className="ic"><Icon3D name="check" size={72} /></div>
        ...
        <div className="container">
          <div className="checkout-layout">
            <div className="form-card">
              <div className="delivery-note"><Icon3D name="truck" size={34} /> <span>التوصيل متوفر لكل محافظات العراق — 3,000 د.ع داخل كربلاء، و5,000 د.ع لبقية المحافظات.</span></div>
              ...
              <>
                ...
                <div className="pay-options">
                  <button className="pay-option" onClick={() => setPaymentMethod('cod')}>
                    <div className="pay-option-icon"><Icon3D name="money" size={48} /></div>
                  ...
                  <button className="pay-option" onClick={() => setPaymentMethod('electronic')}>
                    <div className="pay-option-icon"><Icon3D name="card" size={48} /></div>
                ...
                {paymentMethod === 'electronic' && (
                  <div className="pay-accounts">
                    <div className="pay-account-card">
                      ...
                      <div className="pay-account-number" onClick={() => navigator.clipboard?.writeText('07805500408')}>
                        07805500408 <span className="pay-copy-hint">اضغطي للنسخ</span>
                      </div>
                    </div>
                    <div className="pay-account-card" style={{ marginTop: 12 }}>
                      <h5>ماستر كارد (Mastercard)</h5>
                      <div className="pay-account-number" onClick={() => navigator.clipboard?.writeText('3857887354')}>
