...
export default function Shop() {
  ...
  return <><PageHead title="المتجر" crumb="الرئيسية / المتجر" /><section className="section" style={{ paddingTop: 60 }}><div className="container">
    ...
    {!loading && !list.length && <div className="empty-state" style={{ gridColumn: "1/-1" }}><div className="ic"><Icon3D name="bag" size={72} /></div><p>{searchQ ? "لا توجد نتائج مطابقة لبحثك" : "لا توجد منتجات في هذا القسم حاليًا"}</p></div>}
