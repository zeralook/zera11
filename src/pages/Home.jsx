...
const DEFAULT_HERO = "https://images.unsplash.com/photo-1682745230951-8a5aa9a474a0?crop=entropy&cs=srgb&fm=jpg&q=80&w=1600";
const DEFAULT_CATS = {
  جنط: "https://images.pexels.com/photos/7953286/pexels-photo-7953286.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
  جديدنا: "https://images.unsplash.com/photo-1629511565591-a1d494ad6c58?crop=entropy&cs=srgb&fm=jpg&q=80&w=900",
  الاكثر: "https://images.unsplash.com/photo-1614179689702-355944cd0918?crop=entropy&cs=srgb&fm=jpg&q=80&w=900",
  عروض: "https://images.unsplash.com/photo-1571513800374-df1bbe650e56?crop=entropy&cs=srgb&fm=jpg&q=80&w=900"
};

export default function Home() {
  const [heroImage, setHeroImage] = useState(DEFAULT_HERO);
  const [catImages, setCatImages] = useState(DEFAULT_CATS);

  useEffect(() => {
    api('/api/config').then(cfg => {
      if(cfg.heroImage) setHeroImage(cfg.heroImage);
      setCatImages({
        جنط: cfg.catجنط || DEFAULT_CATS.جنط,
        جديدنا: cfg.catجديدنا || DEFAULT_CATS.جديدنا,
        الاكثر: cfg.catالاكثر || DEFAULT_CATS.الاكثر,
        عروض: cfg.catعروض || DEFAULT_CATS.عروض
      });
    }).catch(() => {});
  }, []);
        ...
        <div className="container">
          ...
          <div className="bento reveal">
            ...
            <Link to="/shop?cat=جديدنا" className="bento-card bento-c2">
              <img src={catImages.جديدنا} alt="جديدنا" />
            ...
            <Link to="/shop?cat=الأكثر مبيعًا" className="bento-card bento-c3">
              <img src={catImages.الاكثر} alt="الأكثر مبيعًا" />
            ...
            <Link to="/shop?cat=عروض" className="bento-card bento-c4">
              <img src={catImages.عروض} alt="عروض" />
      ...
      <section className="section section-navy">
        <div className="container about-split">
          <div className="about-visual reveal">
            <img src="/about-zera.jpg" alt="ZERA" />
          </div>
