...
export default function Product() {
  ...
  // الصورة الرئيسية:
  // - إذا ما في لون مختار → أول صورة عامة
  // - إذا في لون مختار وعنده صورة → صورة اللون
  // - إذا في لون مختار وما عنده صورة → أول صورة عامة
  const displayImage = colorImage || generalImages[0] || product.image;
        ...
        <div className="product-layout">
          ...
          <div className="product-info">
            ...
            <button
              ...
              onClick={() => addToCart(
                product.id, qty,
                (selectedColor !== null ? product.colors?.[selectedColor] : null),
