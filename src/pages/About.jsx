...
export default function About() {
  const [aboutImage, setAboutImage] = useState('/about-zera.jpg');
  useEffect(() => {
    api('/api/config').then(cfg => { if(cfg.aboutImage) setAboutImage(cfg.aboutImage); }).catch(()=>{});
  }, []);
  return (
    <>
      ...
      <section className="section">
        <div className="container about-split">
          <div className="about-identity" style={{ padding: 0, background: "none", border: "none" }}>
            <img src={aboutImage} alt="ZERA" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: 12, display: "block" }} />
          </div>
          <div>
