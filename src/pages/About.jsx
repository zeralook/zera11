      ...
      <section className="section section-cream">
        <div className="container">
          ...
          <div className="value-cards">
            <div className="value-card"><div className="ic"><Icon3D name="bag" size={58} /></div><h4>جودة مختارة</h4><p style={{ color: "#6b5f52", fontSize: 14, marginTop: 8 }}>كل قطعة تمر بفحص دقيق قبل وصولها إليك</p></div>
            <div className="value-card"><div className="ic"><Icon3D name="truck" size={58} /></div><h4>توصيل شامل</h4><p style={{ color: "#6b5f52", fontSize: 14, marginTop: 8 }}>نوصل لجميع محافظات العراق دون استثناء</p></div>
            <div className="value-card"><div className="ic"><Icon3D name="message" size={58} /></div><h4>دعم مباشر</h4><p style={{ color: "#6b5f52", fontSize: 14, marginTop: 8 }}>تواصل سهل وسريع عبر واتساب وإنستغرام</p></div>
          </div>
        </div>
      </section>
    </>
