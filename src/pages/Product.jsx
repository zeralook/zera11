...
export default function Product() {
  ...
  // لما في صورة للون — اعرضها أول شي
  ...
  // الصورة الرئيسية = صورة اللون إذا موجودة، وإلا أول صورة من الـ gallery
  const displayImage = gallery[activeThumb] || colorImage || product.image;
