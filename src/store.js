...
export function bagIcon(color = "#0D1929") {
  ...
  return `<svg class="bag-icon-3d" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="bag-gold" x1="18" y1="18" x2="82" y2="88" gradientUnits="userSpaceOnUse">
        <stop stop-color="#F0D5A5"/><stop offset="0.5" stop-color="${safe}"/><stop offset="1" stop-color="#7D5A32"/>
      </linearGradient>
      <filter id="bag-shadow" x="5" y="5" width="90" height="92" filterUnits="userSpaceOnUse">
        <feDropShadow dx="0" dy="5" stdDeviation="4" flood-color="#0D1929" flood-opacity=".22"/>
      </filter>
    </defs>
    <g filter="url(#bag-shadow)">
      <path d="M30 38V28C30 18.6 38.2 14 50 14s20 4.6 20 14v10" stroke="url(#bag-gold)" stroke-width="4"/>
      <rect x="18" y="38" width="64" height="50" rx="8" fill="rgba(245,234,215,.18)" stroke="url(#bag-gold)" stroke-width="4"/>
      <path d="M23 54h54" stroke="url(#bag-gold)" stroke-width="2" opacity=".5"/>
      <circle cx="50" cy="65" r="4" fill="url(#bag-gold)"/>
    </g>
  </svg>`;
}
