...
app.post('/api/admin/settings', auth, async (req,res) => {
  try {
    const body = req.body || {};
    const map = {
      heroImage:'hero_image', aboutImage:'about_image',
      'catجنط':'cat_جنط', 'catجديدنا':'cat_جديدنا',
      'catعروض':'cat_عروض', 'catالاكثر':'cat_akther'
    };
...
app.get('/api/config', async (req,res) => {
  try {
    const result = {
      ...
      catجنط: null, catجديدنا: null, catعروض: null, catالاكثر: null
    };
    const dbMap = {
      'hero_image':'heroImage','about_image':'aboutImage',
